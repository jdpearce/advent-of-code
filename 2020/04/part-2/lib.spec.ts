import { countValidPassports } from '../part-1/lib';
import { isPassportValid } from './lib';

describe('2020-12-04.2', () => {
...
iyr:2010 hgt:158cm hcl:#b6652a ecl:blu byr:1944 eyr:2021 pid:093154719`.split('\n');
  ...
  describe('isPassportValid', () => {
    ...
    it('should validate passport list correctly', () => {
      expect(countValidPassports(valid, isPassportValid)).toBe(4);
    });

    it('should invalidate passport list correctly', () => {
      expect(countValidPassports(invalid, isPassportValid)).toBe(0);
    });
  });
});
